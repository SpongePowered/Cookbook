...
public class WorldEditingTest {
    ...
    public void onServerStarting(ServerStartingEvent event) {
        game.getCommandDispatcher().register(instance, new Commands(), "cstat");
    }
    ...
    private class Commands implements CommandCallable {
        ...
        public boolean testPermission(CommandSource source) {
            return source.hasPermission("command.sponge.cstat");
        }
        ...
        public Optional<CommandResult> process(CommandSource source, String arguments) throws CommandException {
            if (source instanceof Player) {
                ...
                final Vector3i blockPosition = getPosition(player, arguments.split(" "));
                ...
                final Extent extent = world;
                player.sendMessage(Texts.of(extent.getBlock(blockPosition).getType().getName()));
                player.sendMessage(Texts.of(extent.getBiome(biomePosition).getName()));
                extent.setBiome(biomePosition, BiomeTypes.SWAMPLAND);
                extent.setBlock(blockPosition, BlockTypes.GRASS.getDefaultState());
    ...
    private static Vector3i getPosition(Player player, String[] arguments) throws CommandException {
